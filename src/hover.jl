...
@eval function handle_HoverRequest(server::Server, msg::HoverRequest)
    ...
    # this is necessary because the module context generated by JET is not a normal package module context
    documentation = Base.Docs.doc($(Expr(:new, Base.Docs.Binding, :parentmod, :identifier)))

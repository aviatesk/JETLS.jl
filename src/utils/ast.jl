...
"""
    prev_nontrivia_byte(ps::JS.ParseStream, b::Int; pass_newlines=false)
...
"""
    prev_nontrivia(ps::JS.ParseStream, b::Int; pass_newlines=false)
...
```
"""
function prev_nontrivia(ps::JS.ParseStream, b::Int; pass_newlines=false)
...
"""
    next_nontrivia_byte(ps::JS.ParseStream, b::Int; pass_newlines=false)
...
```
"""
function next_nontrivia(ps::JS.ParseStream, b::Int; pass_newlines=false)
    1 ≤ b ≤ JS.last_byte(ps) || return nothing

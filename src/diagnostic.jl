...
function analyze_undefined_global_bindings!(
        ...
        binding_occurrences::Dict{JL.BindingInfo,Set{BindingOccurrence{Tree3}}},
        world::UInt, reported::Set{LoweringDiagnosticKey};
...
function analyze_lowered_code!(
    ...
    skip_analysis_requiring_context ||
        analyze_undefined_global_bindings!(diagnostics, fi, ctx3, binding_occurrences,
            world, reported; analyzer, postprocessor)

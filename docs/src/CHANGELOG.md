...
!!! warning
    ...
    each re-analysis ([aviatesk/JETLS.jl#357](https://github.com/aviatesk/JETLS.jl/issues/357)).
...
- Added `inference/field-error` diagnostic for detecting access to non-existent
  ...
  Closed [aviatesk/JETLS.jl#392](https://github.com/aviatesk/JETLS.jl/issues/392).
...
- Added completion support for Julia keywords.
  Closed [aviatesk/JETLS.jl#386](https://github.com/aviatesk/JETLS.jl/issues/386).
...
- Fixed false negative unused argument diagnostics for functions with keyword
  ...
  `a` as unused. Fixed [aviatesk/JETLS.jl#390](https://github.com/aviatesk/JETLS.jl/issues/390).
...
- Fixed wrong message for diagnostic with multiple stack frames.
  ...
  Fixed [aviatesk/JETLS.jl#393](https://github.com/aviatesk/JETLS.jl/issues/393).
...
- Completions now return no results when the prefix type is unknown.
  ...
  Fixed [aviatesk/JETLS.jl#389](https://github.com/aviatesk/JETLS.jl/issues/389).
...
- Fixed false positive unused variable diagnostics in comprehensions with filter
  ...
  Fixes [aviatesk/JETLS.jl#360](https://github.com/aviatesk/JETLS.jl/issues/360).
...
- Fixed source location links in hover content to use comma-delimited format
  ...
  Fixes [aviatesk/JETLS.jl#281](https://github.com/aviatesk/JETLS.jl/issues/281).
...
- Request handlers now wait for file cache to be populated instead of immediately
  ...
  ([aviatesk/JETLS.jl#273](https://github.com/aviatesk/JETLS.jl/issues/273),
   [aviatesk/JETLS.jl#274](https://github.com/aviatesk/JETLS.jl/issues/274),
   [aviatesk/JETLS.jl#327](https://github.com/aviatesk/JETLS.jl/issues/327))
- Fixed glob pattern matching for `diagnostic.patterns[].path`: `**` now
  ...
  ([aviatesk/JETLS.jl#359](https://github.com/aviatesk/JETLS.jl/pull/359))
...
- Added heap snapshot profiling support. Create a `.JETLSProfile` file in the
  ...
  See [DEVELOPMENT.md's Profiling](https://github.com/aviatesk/JETLS.jl/blob/master/DEVELOPMENT.md#profiling) section for details.
...
- Fixed false `lowering/macro-expansion-error` diagnostics appearing before
  ...
  Fixes [aviatesk/JETLS.jl#279](https://github.com/aviatesk/JETLS.jl/issues/279) and
  [aviatesk/JETLS.jl#290](https://github.com/aviatesk/JETLS.jl/issues/290).
  ([aviatesk/JETLS.jl#333](https://github.com/aviatesk/JETLS.jl/pull/333))
...
- Added CI workflow for testing the vendored release environment.
  ...
  ([aviatesk/JETLS.jl#321](https://github.com/aviatesk/JETLS.jl/pull/321))
...
- Fixed vendoring script to remove unused weakdeps and extensions from vendored
  ...
  Fixes [aviatesk/JETLS.jl#312](https://github.com/aviatesk/JETLS.jl/issues/312).
  ([aviatesk/JETLS.jl#320](https://github.com/aviatesk/JETLS.jl/pull/320))
...
- Implemented environment isolation via dependency vendoring to prevent conflicts
  ...
  ([aviatesk/JETLS.jl#314](https://github.com/aviatesk/JETLS.jl/pull/314))
  - For developers:
...
- Changed diagnostic configuration schema from `[diagnostic.codes]` to
  ...
  ([aviatesk/JETLS.jl#299](https://github.com/aviatesk/JETLS.jl/pull/299))
...
- Added configurable diagnostic serveirty support with hierarchical diagnostic
  ...
  ([aviatesk/JETLS.jl#298](https://github.com/aviatesk/JETLS.jl/pull/298))
...
- Added file path-based filtering for diagnostic patterns.
  ...
  ([aviatesk/JETLS.jl#313](https://github.com/aviatesk/JETLS.jl/pull/313))
- Added LSP `codeDescription` implementation with clickable documentation links
  for diagnostics. ([aviatesk/JETLS.jl#298](https://github.com/aviatesk/JETLS.jl/pull/298))
- Added this change log. ([aviatesk/JETLS.jl#316](https://github.com/aviatesk/JETLS.jl/pull/316))
...
- Fixed UTF-8 position encoding to use byte offsets instead of character counts.
  ...
  ([aviatesk/JETLS.jl#306](https://github.com/aviatesk/JETLS.jl/pull/306))
